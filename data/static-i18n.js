...
(function () {
  ...
  const DICT = {
    ...
    "Schengen states covered": { tr:"Kapsanan Schengen ülkeleri" },
    "If your country's passport currently lets you enter Schengen visa-free for short stays (and you're": { tr:"Ülkenin pasaportu şu an kısa kalışlar için Schengen'e vizesiz giriş sağlıyorsa (ve sen" },
    "EU / EEA / Swiss citizens": { tr:"AB / AEA / İsviçre vatandaşları" },
    "— freedom of movement applies; nothing changes.": { tr:"— serbest dolaşım geçerli; hiçbir şey değişmez." },
    "Travellers who already need a Schengen visa": { tr:"Halihazırda Schengen vizesine ihtiyaç duyan yolcular" },
    "(Turkey, India, China, Russia, most African and Middle-Eastern passports) — keep applying for visas as usual.": { tr:"(Türkiye, Hindistan, Çin, Rusya, çoğu Afrika ve Orta Doğu pasaportu) — her zamanki gibi vize başvurusu yapmaya devam edin." },
    "Long-stay (more than 90 days)": { tr:"Uzun kalış (90 günden fazla)" },
    "— that's a national visa or residence permit, not ETIAS.": { tr:"— bu ulusal bir vize veya oturma izni, ETIAS değil." },
    "Work / study / family reunification": { tr:"Çalışma / eğitim / aile birleşimi" },
    "— full visa categories, not touched by ETIAS.": { tr:"— tam vize kategorileri, ETIAS bunlara dokunmaz." },
    "— not part of Schengen; no ETIAS needed for Ireland.": { tr:"— Schengen'in parçası değil; İrlanda için ETIAS gerekmez." },
    "Open the official ETIAS portal:": { tr:"Resmi ETIAS portalını aç:" },
    ". Beware of scam sites — only use the .europa.eu domain.": { tr:". Dolandırıcı sitelere dikkat — yalnızca .europa.eu alan adını kullan." },
    "Fill in passport details, travel plans, criminal history questions.": { tr:"Pasaport bilgileri, seyahat planları ve sabıka geçmişi sorularını doldur." },
    "Pay the €7 fee with a credit/debit card.": { tr:"7 €'luk ücreti kredi/banka kartıyla öde." },
    "Most applicants get approval within 96 hours — keep your ETIAS number handy at the airport.": { tr:"Çoğu başvuru sahibi 96 saat içinde onay alır — ETIAS numaranı havalimanında elinin altında tut." },
    "Authorization is tied to your passport. Renew when the passport expires.": { tr:"Yetkilendirme pasaportuna bağlıdır. Pasaport süresi dolduğunda yenile." },
    "Is ETIAS a visa?": { tr:"ETIAS bir vize mi?" },
    "No. It's a pre-travel security authorization, similar to the US ESTA. You still go through normal border control on arrival.": { tr:"Hayır. ABD ESTA'sına benzer, seyahat öncesi bir güvenlik yetkilendirmesidir. Varışta yine normal sınır kontrolünden geçersin." },
    "What if I'm refused?": { tr:"Reddedilirsem ne olur?" },
    "You'll get a reason (criminal record, prior overstay, security concern). You can appeal, or apply for a regular Schengen short-stay visa instead.": { tr:"Bir gerekçe verilir (sabıka kaydı, önceki süre aşımı, güvenlik endişesi). İtiraz edebilir veya bunun yerine normal Schengen kısa-kalış vizesine başvurabilirsin." },
    "What if I have dual citizenship?": { tr:"Çifte vatandaşsam ne olur?" },
    "Apply with the passport you'll travel on. If one of your passports is EU/EEA, use that — no ETIAS needed.": { tr:"Seyahat edeceğin pasaportla başvur. Pasaportlarından biri AB/AEA ise onu kullan — ETIAS gerekmez." },
    "What happens at the border?": { tr:"Sınırda ne olur?" },
    "The carrier checks ETIAS before boarding. Schengen border guards check on arrival. Without it, you can be refused boarding.": { tr:"Taşıyıcı, biniş öncesi ETIAS'ı kontrol eder. Schengen sınır görevlileri varışta kontrol eder. ETIAS olmadan uçağa alınmayabilirsin." },
    "Spotted something wrong? Open an issue at": { tr:"Bir hata mı fark ettin? Şuradan bildir:" },

    // ── About page body ──
    "Free · Open data · Daily refresh": { tr:"Ücretsiz · Açık veri · Günlük güncelleme" },
    "If something on a country page looks off, get in touch — we'd like to hear about it and fix it quickly.": { tr:"Bir ülke sayfasında bir şey yanlış görünüyorsa bize ulaş — duymak ve hızlıca düzeltmek isteriz." },
    "Not an official source.": { tr:"Resmi bir kaynak değildir." },
    "Visa policies change frequently and unevenly. Always confirm with the destination's embassy or consulate before booking.": { tr:"Vize politikaları sık ve düzensiz değişir. Rezervasyondan önce her zaman hedef ülkenin elçilik veya konsolosluğuyla teyit et." },
    "Not a visa application service.": { tr:"Vize başvuru hizmeti değildir." },
    ...
    "A dedicated contact address is being set up. Until then, please open an issue at": { tr:"Özel bir iletişim adresi oluşturuluyor. O zamana kadar lütfen şuradan bir konu aç:" },
    "for feedback, data corrections, or partnership inquiries.": { tr:"geri bildirim, veri düzeltmeleri veya iş birliği talepleri için." },
    "Country flags are Unicode emoji. All other content on this site is provided as-is for reference; verify any visa requirement with the destination embassy before booking.": { tr:"Ülke bayrakları Unicode emojidir. Bu sitedeki diğer tüm içerik referans amaçlı olduğu gibi sunulur; rezervasyondan önce her vize gereksinimini hedef elçilikle doğrula." },

    // ── Privacy page body ──
    "Last updated: 2026-05-21 · Operator: travelnow.info": { tr:"Son güncelleme: 2026-05-21 · İşletmeci: travelnow.info" },
    "for the same purpose; that value is never sent to us.": { tr:"aynı amaçla; bu değer bize asla gönderilmez." },
    "Every alert email contains a one-click unsubscribe link that deletes your record immediately and (if applicable) cancels your Stripe subscription.": { tr:"Her uyarı e-postası, kaydını anında silen ve (varsa) Stripe aboneliğini iptal eden tek tıklamalık bir abonelikten-çık bağlantısı içerir." },
    "We use the following third-party services, each with their own privacy policy:": { tr:"Her biri kendi gizlilik politikasına sahip şu üçüncü-taraf hizmetleri kullanıyoruz:" },
    "serves the ads on this site. AdSense may use cookies and similar technologies to personalize the ads you see and to measure performance.": { tr:"bu sitedeki reklamları sunar. AdSense, gördüğün reklamları kişiselleştirmek ve performansı ölçmek için çerezler ve benzer teknolojiler kullanabilir." },
    ...
    "Visa, not ETIAS": { tr:"Vize, ETIAS değil" },
    "We don't have ETIAS data for this passport yet.": { tr:"Bu pasaport için henüz ETIAS verimiz yok." },
    ...
    // ETIAS
    "(European Travel Information & Authorization System) approval. US, UK, Canadian, Australian, Japanese, Korean, Brazilian and 60+ other passport holders are affected. €7, valid 3 years, applied online in minutes.": { tr:"(Avrupa Seyahat Bilgi ve İzin Sistemi) onayı. ABD, İngiltere, Kanada, Avustralya, Japonya, Kore, Brezilya ve 60'tan fazla diğer pasaport sahibi etkileniyor. 7 €, 3 yıl geçerli, dakikalar içinde çevrimiçi başvurulur." },
    "Launch date has been pushed back several times — most recently to": { tr:"Başlangıç tarihi birkaç kez ertelendi — en son şu tarihe:" },
    "October 2026": { tr:"Ekim 2026" },
    ", with a 6-month grace period. The numbers above will be updated when the EU posts a final confirmation. Bookmark this page or": { tr:", 6 aylık geçiş süresiyle. Yukarıdaki rakamlar AB nihai onayı yayınladığında güncellenecek. Bu sayfayı yer imlerine ekle veya" },
    "subscribe to alerts": { tr:"uyarılara abone ol" },
    "for updates.": { tr:"güncellemeler için." },
    "Ireland": { tr:"İrlanda" },
    "EU Commission": { tr:"AB Komisyonu" },
    // passport-validity
    "Why airlines care.": { tr:"Havayolları neden önemser." },
    "If you arrive at the destination with a passport that violates the rule, the airline has to fly you back at their cost — plus a fine in many jurisdictions. So they check at check-in and refuse boarding.": { tr:"Hedefe kuralı ihlal eden bir pasaportla varırsan, havayolu seni kendi masrafıyla geri uçurmak zorunda kalır — birçok ülkede ayrıca ceza öder. Bu yüzden check-in'de kontrol edip uçağa almazlar." },
    "Renewal lead times.": { tr:"Yenileme süreleri." },
    "US passport renewal: routine ~6 weeks, expedited ~3. UK: ~3 weeks. Türkiye: same day at PTT. India: 4-6 weeks. Plan accordingly — don't book the flight first.": { tr:"ABD pasaport yenileme: normal ~6 hafta, hızlandırılmış ~3. İngiltere: ~3 hafta. Türkiye: PTT'de aynı gün. Hindistan: 4-6 hafta. Buna göre planla — önce uçağı alma." },
    "Special cases.": { tr:"Özel durumlar." },
    "Diplomatic, service, refugee travel documents have different rules per destination — always check with the embassy. Children's passports often have shorter validity (5 vs 10 years).": { tr:"Diplomatik, hizmet ve mülteci seyahat belgelerinin her ülkeye göre farklı kuralları vardır — her zaman elçilikle teyit et. Çocuk pasaportlarının geçerliliği genelde daha kısadır (10 yerine 5 yıl)." },
    "Spot a wrong rule? Open an issue at": { tr:"Yanlış bir kural mı gördün? Şuradan bir konu aç:" },
    "6 months past stay": { tr:"kalıştan 6 ay sonrasına kadar" },
    "— most of Asia, the Middle East, Africa, Latin America, plus several others (China, India, Indonesia, Türkiye, UAE, Saudi Arabia, Brazil, South Africa…).": { tr:"— Asya'nın çoğu, Orta Doğu, Afrika, Latin Amerika ve birçok başka ülke (Çin, Hindistan, Endonezya, Türkiye, BAE, Suudi Arabistan, Brezilya, Güney Afrika…)." },
    "3 months past stay": { tr:"kalıştan 3 ay sonrasına kadar" },
    "— the Schengen Area (all 29 states), plus most Balkan and North African states (Albania, Bosnia, Morocco, Tunisia, Algeria, South Korea).": { tr:"— Schengen Bölgesi (29 ülkenin tamamı) ve çoğu Balkan ile Kuzey Afrika ülkesi (Arnavutluk, Bosna, Fas, Tunus, Cezayir, Güney Kore)." },
    "Valid for the duration of stay only": { tr:"Yalnızca kalış süresi boyunca geçerli" },
    "— the United States, Canada, Mexico, Ireland and the United Kingdom.": { tr:"— ABD, Kanada, Meksika, İrlanda ve İngiltere." },
    // visa-shortcuts
    "How to use a shortcut.": { tr:"Kısayol nasıl kullanılır." },
    ...
    "The qualifying visa must be valid": { tr:"Uygun vize geçerli olmalı" },
    "on the day of entry. A US visa that expires next week won't unlock a Türkiye eVisa for a trip in 3 months.": { tr:"giriş günü itibarıyla. Önümüzdeki hafta dolacak bir ABD vizesi, 3 ay sonraki bir seyahat için Türkiye e-vizesini açmaz." },
    "Diplomatic / service / special passports": { tr:"Diplomatik / hizmet / hususi pasaportlar" },
    "have their own set of shortcuts — usually more generous. Holders should check the destination's MFA page for bilateral agreements specific to those passport types.": { tr:"kendi kısayol setlerine sahiptir — genelde daha cömert. Sahipleri, bu pasaport türlerine özel ikili anlaşmalar için hedef ülkenin Dışişleri sayfasını kontrol etmeli." },
    "Have a shortcut we should add? Open an issue at": { tr:"Eklememiz gereken bir kısayol mu var? Şuradan bir konu aç:" },
    // digital-nomad
    "How to read the table.": { tr:"Tablo nasıl okunur." },
    "Tax-break summaries are deliberately short — every programme has fine print, double-tax treaties, and residency-day thresholds that change the real outcome. Always run the numbers with a local accountant before deciding.": { tr:"Vergi avantajı özetleri bilinçli olarak kısadır — her programın ince yazısı, çifte vergilendirme anlaşmaları ve gerçek sonucu değiştiren ikamet-gün eşikleri vardır. Karar vermeden önce her zaman yerel bir muhasebeciyle hesapla." },
    "All regions": { tr:"Tüm bölgeler" },
    "Europe": { tr:"Avrupa" },
    "Asia / Oceania": { tr:"Asya / Okyanusya" },
    "Americas": { tr:"Amerika kıtaları" },
    "Middle East / Africa": { tr:"Orta Doğu / Afrika" },
    // CBI
    "CBI vs RBI.": { tr:"CBI ile RBI farkı." },
    "CBI grants a second": { tr:"CBI ikinci bir" },
    "passport": { tr:"pasaport" },
    "directly, usually after a 4-12 month process. RBI (Golden Visa) grants a renewable": { tr:"doğrudan verir, genelde 4-12 aylık bir süreçten sonra. RBI (Altın Vize) yenilenebilir bir" },
    "residence permit": { tr:"oturma izni" },
    "; you can apply for citizenship later through the country's regular naturalisation timeline (typically 5-10 years of physical residency, depending on the jurisdiction).": { tr:" verir; vatandaşlık için daha sonra ülkenin normal vatandaşlığa geçiş süreciyle başvurabilirsin (genelde ülkeye göre 5-10 yıl fiili ikamet)." },
    "Minimum investment": { tr:"Asgari yatırım" },
    "Visa-free score": { tr:"Vizesiz skoru" },
    "Tax planning.": { tr:"Vergi planlaması." },
    "Spotted an outdated figure, a closed programme we forgot to mark, or a new launch we missed? Open an issue at": { tr:"Eski bir rakam, kapanmış ama işaretlemediğimiz bir program ya da kaçırdığımız yeni bir başlangıç mı gördün? Şuradan bir konu aç:" },
    "All": { tr:"Tümü" },
    "CBI (passport)": { tr:"CBI (pasaport)" },
    "RBI (residence)": { tr:"RBI (oturum)" },
    // schengen-calculator
    "Free, instant, no signup. Enter your past trips into the Schengen Area — see exactly how many of your 90 days you've already used in the rolling 180-day window, and plan future visits without breaking the rule.": { tr:"Ücretsiz, anında, üyeliksiz. Schengen Bölgesi'ne geçmiş seyahatlerini gir — kayan 180 günlük pencerede 90 gününün ne kadarını kullandığını tam olarak gör ve kuralı çiğnemeden ileriki ziyaretleri planla." },
    "Include both the day you crossed into Schengen and the day you crossed out — both count.": { tr:"Hem Schengen'e girdiğin günü hem çıktığın günü dahil et — ikisi de sayılır." },
    "Detailed document checklists for the most common pairs:": { tr:"En yaygın güzergahlar için ayrıntılı belge kontrol listeleri:" },
    "Under": { tr:"Şu mevzuat uyarınca:" },
    "Regulation (EU) 2018/1806": { tr:"Tüzük (AB) 2018/1806" },
    ", short-stay travellers in the Schengen Area may stay a maximum of": { tr:", Schengen Bölgesi'ndeki kısa-kalış yolcuları en fazla şu kadar kalabilir:" },
    "90 days within any rolling 180-day window": { tr:"herhangi bir kayan 180 günlük pencere içinde 90 gün" },
    ". The window is not a fixed calendar period: each day you are physically in Schengen you \"spend\" one of your 90 days; that day will be \"refunded\" exactly 180 days later.": { tr:". Pencere sabit bir takvim dönemi değildir: Schengen'de fiziksel olarak bulunduğun her gün 90 gününden birini \"harcarsın\"; o gün tam 180 gün sonra \"iade edilir\"." },
    "The UK and Ireland are": { tr:"İngiltere ve İrlanda" },
    "in Schengen — time spent there doesn't count toward the 90/180 limit. Holding an EU residence card (e.g. Spain Non-Lucrative, Portugal D7) means you live there legally and aren't subject to the short-stay rule for that country, but days in": { tr:"Schengen'de değildir — orada geçirdiğin süre 90/180 limitine sayılmaz. Bir AB oturma kartına (örn. İspanya Non-Lucrative, Portekiz D7) sahip olmak, orada yasal olarak yaşadığın ve o ülke için kısa-kalış kuralına tabi olmadığın anlamına gelir, ancak şu ülkelerdeki günler:" },
    "other": { tr:"diğer" },
    "Schengen countries still count.": { tr:"Schengen ülkelerindeki günler yine sayılır." },
    "🇹🇷 Türkiye → Schengen": { tr:"🇹🇷 Türkiye → Schengen" },
    "How the 90 / 180 rule actually works": { tr:"90 / 180 kuralı gerçekte nasıl işler" },
    ...
    // privacy
    "locally in your browser": { tr:"tarayıcında yerel olarak" },
    "Google Privacy Policy": { tr:"Google Gizlilik Politikası" },
    "Cloudflare Privacy Policy": { tr:"Cloudflare Gizlilik Politikası" },
    "Stripe Privacy Policy": { tr:"Stripe Gizlilik Politikası" },
    "Resend Privacy Policy": { tr:"Resend Gizlilik Politikası" },
    "Affiliate partners": { tr:"Ortaklık iş ortakları" },
    ...
    "Saved in this browser": { tr:"Bu tarayıcıda kayıtlı" },
    "Passport": { tr:"Pasaport" },
    "Watched destinations": { tr:"İzlenen ülkeler" },
    "Planned trip": { tr:"Planlanan seyahat" },
    "Schengen calculator trips": { tr:"Schengen hesaplayıcı seyahatleri" },
    "Loading…": { tr:"Yükleniyor…" },
    "Finish signing in": { tr:"Girişi tamamla" },
    "Enter the email address the sign-in link was sent to.": { tr:"Giriş bağlantısının gönderildiği e-posta adresini yaz." },
    "Sign in": { tr:"Giriş yap" },
    "Sign in to keep your passport, watched destinations, planned trip and Schengen calculator trips on every device. No password — use Google or a one-time link by email.": { tr:"Pasaportun, izlediğin ülkeler, planladığın seyahat ve Schengen hesaplayıcı seyahatlerin her cihazda seninle olsun diye giriş yap. Şifre yok — Google'ı ya da e-postayla gelen tek kullanımlık bağlantıyı kullan." },
    "Continue with Google": { tr:"Google ile devam et" },
    "Or get a sign-in link by email": { tr:"Ya da e-postayla giriş bağlantısı al" },
    "Check your inbox — we sent a sign-in link. Open it on this device.": { tr:"Gelen kutuna bak — giriş bağlantısı gönderdik. Bu cihazda aç." },
    "Email me a link": { tr:"Bağlantıyı gönder" },
    "What an account stores": { tr:"Hesapta neler saklanır" },
    "Your email address and the items listed below — nothing else. No passport numbers or documents. You can download or delete it all at any time.": { tr:"E-posta adresin ve aşağıdaki öğeler — başka hiçbir şey. Pasaport numarası ya da belge yok. Hepsini istediğin zaman indirebilir ya da silebilirsin." },
    "Signed in as": { tr:"Giriş yapılan hesap:" },
    "Syncing…": { tr:"Eşitleniyor…" },
    "Couldn't sync — will retry when you change something.": { tr:"Eşitlenemedi — bir şeyi değiştirdiğinde tekrar denenecek." },
    "Up to date on this device.": { tr:"Bu cihazda güncel." },
    "Saved to your account": { tr:"Hesabına kayıtlı" },
    "Sync now": { tr:"Şimdi eşitle" },
    "Download my data": { tr:"Verilerimi indir" },
    "Sign out": { tr:"Çıkış yap" },
    "Delete account": { tr:"Hesabı sil" },
    "Deletes your sign-in and everything stored with it. What's saved in this browser stays here.": { tr:"Girişini ve onunla saklanan her şeyi siler. Bu tarayıcıda kayıtlı olanlar burada kalır." },
    "Delete my account": { tr:"Hesabımı sil" },
    "Tap again to delete permanently": { tr:"Kalıcı olarak silmek için tekrar dokun" },
    "Your account has been deleted.": { tr:"Hesabın silindi." },
    "Sign-in was cancelled.": { tr:"Giriş iptal edildi." },
    "That email address doesn't look right.": { tr:"Bu e-posta adresi doğru görünmüyor." },
    "This sign-in link has expired or was already used. Ask for a new one.": { tr:"Bu giriş bağlantısının süresi dolmuş ya da kullanılmış. Yenisini iste." },
    "No connection — try again.": { tr:"Bağlantı yok — tekrar dene." },
    "For your security, sign out, sign in again, then delete.": { tr:"Güvenliğin için çıkış yap, tekrar giriş yap, sonra sil." },
    "Sign-in isn't set up for this address yet.": { tr:"Bu adres için giriş henüz ayarlanmadı." },
    "Something went wrong. Please try again.": { tr:"Bir şeyler ters gitti. Lütfen tekrar dene." },
    "Email address": { tr:"E-posta adresi" },
    "Sign in to keep your passport, watched destinations, planned trip and Schengen calculator trips on every device. Use Google, your email and a password, or your phone number.": { tr:"Pasaportun, izlediğin ülkeler, planladığın seyahat ve Schengen hesaplayıcı seyahatlerin her cihazda seninle olsun diye giriş yap. Google'ı, e-postanı ve şifreni ya da telefon numaranı kullan." },
    "Email and password": { tr:"E-posta ve şifre" },
    "Password": { tr:"Şifre" },
    "Create account": { tr:"Hesap oluştur" },
    "Forgot password?": { tr:"Şifreni mi unuttun?" },
    "Account created.": { tr:"Hesap oluşturuldu." },
    "Enter your email above, then tap “Forgot password?”.": { tr:"Yukarıya e-postanı yaz, sonra “Şifreni mi unuttun?”a dokun." },
    "We sent a password reset link — check your inbox.": { tr:"Şifre sıfırlama bağlantısı gönderdik — gelen kutuna bak." },
    "Phone number": { tr:"Telefon numarası" },
    "Send code": { tr:"Kod gönder" },
    "We sent a code by SMS.": { tr:"SMS ile bir kod gönderdik." },
    "Enter the 6-digit code": { tr:"6 haneli kodu gir" },
    "Verify": { tr:"Doğrula" },
    "Use another number": { tr:"Başka numara kullan" },
    "That email and password don't match.": { tr:"Bu e-posta ve şifre eşleşmiyor." },
    "There is already an account with that email — sign in instead.": { tr:"Bu e-postayla zaten bir hesap var — giriş yap." },
    "Use a password of at least 6 characters.": { tr:"En az 6 karakterlik bir şifre kullan." },
    "Enter your password.": { tr:"Şifreni yaz." },
    "Too many attempts. Wait a few minutes and try again.": { tr:"Çok fazla deneme. Birkaç dakika bekleyip tekrar dene." },
    "That phone number doesn't look right. Include the country code, like +90 5xx xxx xx xx.": { tr:"Bu telefon numarası doğru görünmüyor. Ülke kodunu ekle, örneğin +90 5xx xxx xx xx." },
    "That code isn't right.": { tr:"Bu kod doğru değil." },
    "That code has expired. Ask for a new one.": { tr:"Bu kodun süresi doldu. Yenisini iste." },
    "We can't send a code right now. Try another sign-in method or try again later.": { tr:"Şu an kod gönderemiyoruz. Başka bir giriş yöntemi dene ya da sonra tekrar dene." },
    "This sign-in method isn't switched on yet.": { tr:"Bu giriş yöntemi henüz açık değil." },
  };
