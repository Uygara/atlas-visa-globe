...
(function () {
  ...
  const DICT = {
    ...
    "Since we don't store personal data, there is nothing for you to access, rectify, or delete on our side. For data held by AdSense or our hosting provider, please contact them directly using the policy links above.": { tr:"Kişisel veri saklamadığımız için bizim tarafımızda erişebileceğin, düzeltebileceğin veya silebileceğin bir şey yok. AdSense veya barındırma sağlayıcımızdaki veriler için lütfen yukarıdaki politika bağlantılarını kullanarak doğrudan onlarla iletişime geç." },
